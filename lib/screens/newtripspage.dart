                          ...
                          child: RaisedButton(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text("Call", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.black),),
  ...
  void topUpEarnings(int fares){
    ...
    earningsRef.once().then((DataSnapshot snapshot) {
      ...
      if(snapshot.value != null){
        ...
        earningsRef.set(adjustedEarnings.toStringAsFixed(2));
        /*double oldEarnings = double.parse(snapshot.value.toString());
        earningsRef.set(oldEarnings.toStringAsFixed(2));*/
      }
