...
class CheckListDialog extends StatelessWidget {
  ...
  Color availabilityColor = Colors.black38;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('Driver CheckList', style: TextStyle(fontFamily: 'Brand-Bold', fontSize: 18),),
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(child: Container(child: Text("Pauline Smith Crescent Elandspark", style: TextStyle(fontSize: 18),)))
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Expanded(child: Container(child: Text("Brain Cap Developers", style: TextStyle(fontSize: 18),)))
